...
/*
二分图 最大匹配 最小顶点覆盖 最小边覆盖相关概念参考博客:https://blog.csdn.net/huangshuai147/article/details/51087275
...
性质定理:
1.在二分图中:最小顶点覆盖=最大匹配数
最小顶点覆盖可以通过找出最大匹配,然后在每对匹配边中取出2端点中任意一个(所选点应尽可能覆盖更多的边),
这些端点构成的集合就是最小顶点覆盖,对于没有构成匹配的点(包括孤立点),
自然不能算入,要求的是最小的顶点覆盖,只选匹配中的足以覆盖所有边.
2.对于在二分图中最大独立集=顶点数-最小点覆盖=顶点数-最大匹配
3.对于二分图中:
